...
const categories = [
  ...
  },
  {
    ...
    desc: "Linker Z, Tie rod, Ball joint and CV joint for smoother ride.",
  },
  {
  ...
  },
  {
    icon: Filter,
    name: "Filters",
    desc: "Fuel Filters for range of cars that protects the engine long-term.",
  },
];
...
export default function SuperiorAbout() {
  return (
    <>
      <Navbar />
