        ...
        <footer className="border-t bg-white">
            <div className="max-w-7xl mx-auto px-6 py-14">
                <div className="grid md:grid-cols-2 gap-12">
                    {/* Left */}
                    <div>
                        <h2 className="text-3xl font-bold text-[#1208FF] mb-6">
                            Superior
                        </h2>
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="text-2xl font-semibold text-[#1208FF] mb-6">
                            Contact Us
                        </h3>
                        ...
                        <div className="space-y-5 text-gray-700">
                            ...
                            <a
                                ...
                                className="flex items-start gap-3 hover:text-[#1208FF] transition"
                            >
                            ...
                            {/* Karachi */}
                            <div>
                                <h4 className="font-semibold text-[#1208FF] mb-2">
                                    Karachi
                                </h4>
                                ...
                                <a
                                    ...
                                    className="flex gap-3 hover:text-[#1208FF] transition"
                                >
